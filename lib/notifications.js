...
mbedConnectorApi.prototype.getCallback = function(options, callback) {
...
mbedConnectorApi.prototype.putCallback = function(data, options, callback) {
  options = extend(true, {}, this.options, options || {});
...
mbedConnectorApi.prototype.deleteCallback = function(options, callback) {
  options = extend(true, {}, this.options, options || {});
...
mbedConnectorApi.prototype.startLongPolling = function(options, callback) {
 ...
 * @param {Object} payload - The payload object from a notification
 */
