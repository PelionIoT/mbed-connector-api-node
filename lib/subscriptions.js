...
mbedConnector.prototype.getResourceSubscription = function(endpoint,
                                                           resource,
                                                           callback,
                                                           options) {
...
mbedConnector.prototype.putResourceSubscription = function(endpoint,
                                                           resource,
                                                           callback,
                                                           options) {
  options = extend(true, {}, this.options, options || {});
...
mbedConnector.prototype.deleteResourceSubscription = function(endpoint,
                                                              resource,
                                                              callback,
                                                              options) {
  options = extend(true, {}, this.options, options || {});
...
mbedConnector.prototype.getEndpointSubscriptions = function(endpoint,
                                                            callback,
                                                            options) {
  options = extend(true, {}, this.options, options || {});
...
mbedConnector.prototype.deleteEndpointSubscriptions = function(endpoint,
                                                               callback,
                                                               options) {
  options = extend(true, {}, this.options, options || {});
