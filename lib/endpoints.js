...
mbedConnector.prototype.getResourceValue = function(endpoint,
                                                    resource,
                                                    callback,
                                                    options) {
  options = extend(true, {}, this.options, options || {});
...
mbedConnector.prototype.putResourceValue = function(endpoint,
                                                    resource,
                                                    value,
                                                    callback,
                                                    options) {
...
mbedConnector.prototype.postResource = function(endpoint,
                                                resource,
                                                value,
                                                callback,
                                                options) {
