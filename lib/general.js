 ...
 * @param callback - A function that is passed the arguments `(error, limits)`
...
/**
 * Gets the current REST API version
 * @param callback - A function that is passed the arguments `(error, version)`
 * where `version` is a string containting the API version (ex. 'v2')
 * @param {Object} [options]
 */
 ...
 * @param callback - A function that is passed the arguments `(error, versions)`
 * @param {Object} [options]
 */
