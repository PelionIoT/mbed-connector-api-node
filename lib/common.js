 ...
 *
 * @fires mbedConnector#notification
 * @fires mbedConnector#registration
 * @fires mbedConnector#reg-update
 * @fires mbedConnector#de-registration
 * @fires mbedConnector#registration-expired
 */
