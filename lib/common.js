 ...
 * @param {string} options.accessKey - Access Key for your Connector account
 * @param {string} [options.host=https://api.connector.mbed.com] - URL for Connector API
 * @param {string} [options.restApiVersion=v2] - Version of Connector REST API to use
 *
 * @fires mbedConnector#notifications
 * @fires mbedConnector#registrations
 * @fires mbedConnector#reg-updates
 * @fires mbedConnector#de-registrations
 * @fires mbedConnector#registrations-expired
 */
